...
class misc{
	...
	// changes made by rahul kushwaha for fetching not returned books details
	public function notReturnedBooks()
    {
		$query = "SELECT * FROM allotment_details WHERE returned='no' AND issued='yes' ORDER BY reg_no";
	...
	// end of changes
	// changes made by rahul kushwaha for fetching report of allotment details
...
<?php
	...
	//changes made by rahul kushwaha for printing not returned books details
	public function notreturnedbooklist(){
		global $base; ?>
		<table width="800" border="1" cellpadding="0" align="center" style="font-size:24px">
		<tr>
			<td width="120" align="center" valign="middle">
			...
			<td width="670" align="center">
				...
				Not Returned Book List :: <?php echo $this->getSemester(); ?> Semester <?php echo $this->getSession(); ?><br />
				</strong>
			</td>
		</tr>
		</table>
...
<?php		
			$query = "SELECT * FROM allotment_details WHERE returned='no' ORDER BY reg_no";
		
		$this->sql->query = $query;
		$arrayq = $this->sql->process();
		$notbooks = $arrayq;
?>
			<thead><tr><th>S.No.</th><th>Reg. No.</th><th>Name</th><th>Branch</th><th>No. of Books</th>
			</tr></thead>
			<tbody>
			<?php
			$bno = 0;
...
<?php
	...
	//end of changes
	//changes made by rahul kushwaha for printing allotment report details
	public function allotmentreportlist(){
		global $base; ?>
		<table width="800" border="1" cellpadding="0" align="center" style="font-size:24px">
		<tr>
			<td width="120" align="center" valign="middle">
			...
			<td width="670" align="center">
				...
				Allotment Report :: <?php echo $this->getSemester(); ?> Semester <?php echo $this->getSession(); ?><br />
				</strong>
			</td>
		</tr>
		</table>
...
TRUNCATE TABLE cancelled;
TRUNCATE TABLE choice;
DELETE FROM login WHERE type='student';
UPDATE counters SET regd=0,token=0 WHERE 1;
TRUNCATE TABLE receipt;
TRUNCATE TABLE tokens;
TRUNCATE TABLE allotment_details;
UPDATE books_master SET rem_copies = total_copies WHERE 1;
*/
	/** --------------------------Menus--------------------------- */
...
<?php	} ?>
			<li><a href="<?php echo $base; ?>contact">Contacts</a></li>
