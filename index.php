...
$page = strtok($path,'?');
$pages = array('home','instruction','cancelreg','books','choice','notice','contact','password','feecollect','reprint','feecancel','stats','bookedit','allot','print','tokenlist','tokens','notreturnedbooks','enterRank','allotmentReport');
	...
	<?php if (isset($_SESSION['admin'])) {
		...
		<li>
			<ul style="display:block">
				...
				<li><a target="_blank" href="http://172.31.57.51/tlb_2014even">Old Website</a></li>
