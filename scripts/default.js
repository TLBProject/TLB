...
$(document).ready(function() {
	...
	// changes made by rahul kushwaha for printing not returned book details
	$('.notreturnedbooklist').click(function() {
		$.post("ajax",{"action":"notreturnedbooklist","prog":$(this).attr('name')},
			function(data,status){
				if(status=="success"){
					var popupWin = window.open('', '_blank', 'width=800,height=600');
					popupWin.document.open();
	...
	//end of changes
	// changes made by rahul kushwaha for printing allotment report
	$('.allotmentreportlist').click(function() {
		$.post("ajax",{"action":"allotmentreportlist","prog":$(this).attr('name')},
			function(data,status){
				if(status=="success"){
					var popupWin = window.open('', '_blank', 'width=800,height=600');
					popupWin.document.open();
	...
	$('.stats').click(function() {
		...
		popupWin.document.write("<html><title>TextBook Lending Bank | Central Library | MNNIT Allahabad</title>"+
			...
			"<p align='center'>"+
			"<b><font color='#000000' size='3'>Motilal Nehru National Institute of Technology Allahabad<br> Allahabad, India.</font></b><br>"+
			"<b><font size='2' face='Georgia Ref'>Central Library</font></b><br><b>Text Book Lending Bank - 2015-16(ODD Semester)</b></p>"+
			"<b><center><font size='2' face='Georgia Ref'>Fee Collection Report</font></b></center></p>"
	...
	$('.cancelprint').click(function() {
		...
		popupWin.document.write("<html><title>TextBook Lending Bank | Central Library | MNNIT Allahabad</title>"+
			...
			"<b><font size='2' face='Georgia Ref'>Central Library</font></b><br><b>Text Book Lending Bank - 2014-15(EVEN semester)</b></p>"
...
function printReciept(info){
	...
	popupWin.document.write("<html><body onLoad='window.print()'>" + 
		...
		"<tr>"+
			...
			"<b><font color='#000000' size='3'>Motilal Nehru National Institute of Technology<br> Allahabad, India."+
			"</font></b><br>"+
			"<b><font size='2' face='Georgia Ref'>Central Library</font></b><br><b>Text Book Lending Bank : 2016-17(EVEN Semester)</b></p>"+
			...
			"</table>"+
			"<p align='center'><small>Login to http://172.31.57.51 using college wifi or LAN for filling the Online Choice Filling and use the Password given above.</small></p>"+
		"<center><strong>In case of any discrepancy, Contact :<br/></strong></center>"+
		"<table style='width:80%;margin:auto'><tr><td>Kamini Varshney</td><td>Rahul Kushwaha</td></tr>"+
						"<tr><td>MCA Second Yr. </td><td>B.Tech Third Yr. ECE </td></tr>"+
						"<tr><td>kammyahv1994@gmail.com</td><td>kushwaharesonance@gmail.com</td></tr>"+
						"<tr><td>&nbsp;</td><td>+91-7706067073</td></tr></table>"+
		"</html>");
	popupWin.document.close(); 
}
...
//for updating issuing details
	$('#acc_noedit').click(function() {
		var ele = $(this);
		if($(this).text() == 'Edit'){
			$(this).siblings().each(function(index, element) {
				$(this).html("<input type='text' value = '" + $(this).text() + "'style='width:" + $(this).width() + "px'>");
